...
A versão `2.0.74+200088` adiciona seleção de branch no envio, painel global de Builds e tratamento normal para projetos sem workflow, mantendo `2.0.73+200087` como a correção anterior dos testes de limpeza.
